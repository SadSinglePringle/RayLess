...
if (Test-Path "bin\astg_diagnostics.exe") {
    Write-Host "✅ Successfully built bin\astg_diagnostics.exe!" -ForegroundColor Green
} else {
    Write-Error "❌ Build failed for astg_diagnostics.exe"
}
